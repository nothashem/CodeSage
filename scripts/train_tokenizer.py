#!/usr/bin/env python3
"""
Script to train the WordPiece tokenizer on CodeSearchNet data.
"""
import os
import json
import logging
...
import numpy as np
from src.tokenizer.subword import BPETokenizer
...
def train_tokenizer(
    ...
    tokenizer = BPETokenizer(vocab_size=vocab_size, min_frequency=min_freq)
